        ...
        <section className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
            ...
            {!callDetails ? (
                <MeetingModal
                    ...
                    <div className="flex flex-col gap-2.5">
                        ...
                        <Textarea className="border-noe bg-dark-3 focus-visible:ring-0 focus-visible:ring-offset-0"
                    ...
                    <div className="flex w-full flex-col gap-2.5">
                        ...
                        <ReactDatePicker
                            ...
                            onChange={(date) => setValues(prevState => ({ ...prevState, dateTime: date! }))}
                            showTimeSelect
                            timeFormat="HH:mm"
                            timeIntervals={15}
                            timeCaption="time"
            ...
            <MeetingModal
                ...
                <Input
                    ...
                    onChange={(e) => setValues(prevState => ({ ...prevState, link: e.target.value }))} />
            </MeetingModal>
        </section>
    )
}
